...
def calculate_odometry():
    ...
    global current_encoder_count, last_encoder_count, motor_velocity, current_time, last_time, dt, current_robot_location_2, last_robot_location_2, motor_velocity
